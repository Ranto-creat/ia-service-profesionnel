...
export default function AnalyseCV() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const res = await fetch("https://cv-resume-angp.onrender.com/analyze_cv", {
                method: "POST",
                body: formData,
            });
            ...
            setError("Impossible d'analyser le CV. Vérifiez votre connexion et réessayez.");
        } finally {
            setUploading(false);
            setProgress(100);
        }
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center text-center">
            <div>
                ...
                <p className="text-lg mb-8">Téléchargez votre CV pour une analyse approfondie.</p>
            </div>
            ...
            <Card className="w-full max-w-md p-6 text-center bg-white shadow-md text-neutral-600">
                ...
                <div className="border border-dashed border-blue-400 p-6 rounded mb-4 bg-blue-50">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">Glisser-déposer un fichier ou cliquez pour parcourir</p>
                </div>
                ...
                <Button disabled={uploading || !file} onClick={handleUpload} className="cursor-pointer">
                    Analyser
                </Button>
