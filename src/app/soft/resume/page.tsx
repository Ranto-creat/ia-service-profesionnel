...
export default function AnalyseCV() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            setError('Analyse échouée. Vérifiez la connexion ou réessayez.');
        } finally {
            setUploading(false);
            setProgress(100);
        }
        ...
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-b from-[#0b0e1b] to-[#151929] text-white px-4">
            <div className="text-center m-10">
                ...
                <p className="text-[1rem] md:text-xl text-gray-100">
                    Téléverse ton CV pour obtenir des retours personnalisés.
                    Notre IA évalue ton CV et te propose des suggestions
                    d'amélioration pour t'aider à te démarquer.
                </p>
            </div>
                ...
                <Dialog open={!!result} onOpenChange={() => setResult(null)}>
                    <DialogContent className="sm:max-w-[850px] max-h-[80vh] overflow-y-auto backdrop-blur-xl border border-white/10 bg-white/5 text-white">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Voici les retours basés sur l’analyse de votre
                                CV :
                            </DialogDescription>
                        </DialogHeader>
